...
- Member 2 (ST10XXXXXX): Categories, Entries & Photo Feature
- Member 3 (ST10XXXXXX): Goals, Reports & Period Views
- Member 4 (ST10XXXXXX): UI/UX & Demo Video
...
The workflow triggers on every push to the `release` branch.
